...
import buildTemplateSyntax from "../template/syntax.js";
import JsxLikeTokenizer from "./jsx-like-tokenizer.js";
import AstroTokenizer from "./astro-tokenizer.js";
import { cssSafeSyntax } from "../syntax/syntaxes.js";
	...
	const parser = new htmlparser.Parser(
		{
			...
			onattribute(name, content) {
				...
				// In htmlparser2 v9, `parser.endIndex` during `onattribute` points
				// one past the end of the attribute value (after the closing quote).
...
export default function extractStyles(source, opts) {
	const styles = [];
